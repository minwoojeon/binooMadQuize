...
<%-- 
/**
 * @Class Name : includecss.jsp
 * @Description : CSS common include
...
@font-face {
	...
	src: url('<c:url value="/resources/fonts/fontawesome-webfont.eot?v=4.6.3"/>');
	src: url('<c:url value="/resources/fonts/fontawesome-webfont.eot?#iefix&v=4.6.3"/>')
