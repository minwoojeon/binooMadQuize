...
<%-- 
/**
 * @Class Name : signup.jsp
 * @Description : user sign-up pages
...
<div id="main">
	<div class="inner">
		...
		<p>저희 사이트를 방문해 주셔서 감사드립니다. 회원이 되시면 보다 많은 이점이 생겨납니다.</p>
		<p></p>
		<h2>이점</h2>
		<ul>
			<li>정오답률</li>
		...
		<p>Thank you for visit our web. If you sign-up, more benefit.</p>
		<p></p>
		<h2>BENEFIT.</h2>
		<ul>
			<li>Your correct or incorrect rates</li>
			<li>If you want make question, please sign-up.</li>
		</ul>
		<p></p>
			...
			<form:form commandName="userVO" name="frm" id="frm" method="post">
				<div class="row uniform">
					...
					<div class="12u$">
						...
						<a href="javascript:$('#pessoninfo').toggle();" class="button fit">개인정보처리방침
							보기 (Show )</a> <input alt="약관에 동의합니다.(I agree.)" type="checkbox"
							id="chk2" name=""> <label for="chk2">약관에 동의합니다.(I
							agree.)</label>
					</div>
					<div class="12u$">
						<h2>가입 필수 정보</h2>
					...
					<div class="12u$ row uniform">
						...
						<div class="6u 12u$(xsmall)">여러분의 거주지역을 입력해주세요.(선택)</div>
					</div>
					<div class="12u$ row uniform">
						<div class="6u 12u$(xsmall)">
